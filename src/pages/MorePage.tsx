    ...
    <div className="flex flex-col min-h-screen pb-24 pt-6 px-4 sm:px-6 md:px-8 max-w-6xl mx-auto w-full">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-3">
          <MoreHorizontal className="h-8 w-8 text-slate-400 light:text-slate-600" />
          <h1 className="text-title-md text-white light:text-slate-900">More Options</h1>
        </div>
      ...
      <div className="card-elevated mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-4xl font-bold text-blue-600 mt-3">{points}</p>
          </div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold text-white light:text-slate-900">{item.label}</h3>
                  <p className="text-xs text-slate-400 light:text-slate-600 mt-1">{item.description}</p>
                </div>
              </div>
            </button>
          );
      ...
      <div className="card-base">
        <h2 className="text-title-sm text-white light:text-slate-900 mb-4">Preferences</h2>
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 rounded-lg border border-slate-200 dark:border-slate-800">
            <div>
              <p className="font-medium text-white light:text-slate-900">Theme</p>
              <p className="text-xs text-slate-400 light:text-slate-600 mt-1">Light or dark mode</p>
            </div>
          ...
          <div className="flex items-center justify-between p-4 rounded-lg border border-slate-200 dark:border-slate-800">
            <div>
              <p className="font-medium text-white light:text-slate-900">Notifications</p>
              <p className="text-xs text-slate-400 light:text-slate-600 mt-1">Habit and task reminders</p>
            </div>
          ...
          <div className="flex items-center justify-between p-4 rounded-lg border border-slate-200 dark:border-slate-800">
            <div>
              <p className="font-medium text-white light:text-slate-900">Data & Privacy</p>
              <p className="text-xs text-slate-400 light:text-slate-600 mt-1">Export or delete your data</p>
            </div>
