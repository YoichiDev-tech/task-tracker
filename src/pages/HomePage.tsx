    ...
    <div className="flex flex-col min-h-screen pb-24 pt-6 px-4 sm:px-6 md:px-8 max-w-6xl mx-auto w-full">
        ...
        <div className="card-base">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white light:text-slate-900 mt-2">{points}</p>
            </div>
        ...
        <div className="card-base">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white light:text-slate-900 mt-2">{tasks.length}</p>
            </div>
        ...
        <div className="card-base">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white light:text-slate-900 mt-2">{habits.length}</p>
            </div>
        ...
        <div className="card-base">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white light:text-slate-900 mt-2">{activeMinutes}m</p>
            </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="card-elevated">
          <div className="mb-6">
            <h2 className="text-title-sm text-white light:text-slate-900">Task Management</h2>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold text-white light:text-slate-900">{tasks.length}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-body">Completion rate</span>
              <span className="font-semibold text-green-600 light:text-green-700">{completionRate}%</span>
            </div>
            <button
        ...
        <div className="card-elevated">
          <div className="mb-6">
            <h2 className="text-title-sm text-white light:text-slate-900">Habit Tracking</h2>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold text-white light:text-slate-900">{habits.length}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-body">Habit streak</span>
              <span className="font-semibold text-purple-600 light:text-purple-700">7 days</span>
            </div>
            <button
      ...
      <div className="card-elevated mb-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-title-sm text-white light:text-slate-900">Focus Timer</h2>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="bg-slate-50 light:bg-white dark:bg-slate-950 rounded-lg p-4 text-center">
            ...
            <p className="text-3xl font-bold text-orange-600 light:text-orange-700 mt-2">{activeMinutes}</p>
            <p className="text-xs text-slate-600 light:text-slate-700 dark:text-slate-400 mt-1">minutes</p>
          </div>
          <button
      ...
      <div className="card-base">
        <h2 className="text-title-sm text-white light:text-slate-900 mb-4">How Points Work</h2>
